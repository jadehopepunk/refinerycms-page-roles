...
ActiveRecord::Schema.define(:version => 20111101000600) do

  create_table "accessible_pages", :force => true do |t|
    t.integer  "user_id"
    t.integer  "page_id"
    t.integer  "position"
  ...
  add_index "accessible_pages", ["id"], :name => "index_accessible_pages_on_id"
